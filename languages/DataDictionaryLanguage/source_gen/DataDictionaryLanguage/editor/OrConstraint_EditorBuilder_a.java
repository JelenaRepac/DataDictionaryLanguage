...
/*package*/ class OrConstraint_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new constraint1SingleRoleHandler_zh7oza_b0(myNode, LINKS.constraint1$nesd, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new constraint2SingleRoleHandler_zh7oza_d0(myNode, LINKS.constraint2$neUf, getEditorContext());
    return provider.createCell();
  }
